...
{
  $Net::Stomp::Producer::Exceptions::VERSION = '0.0.1';
}
{
...
{
  $Net::Stomp::Producer::Exceptions::StackTrace::VERSION = '0.0.1';
}
{
...
{
  $Net::Stomp::Producer::Exceptions::BadMessage::VERSION = '0.0.1';
}
{
...
{
  $Net::Stomp::Producer::Exceptions::CantSerialize::VERSION = '0.0.1';
}
{
...
{
  $Net::Stomp::Producer::Exceptions::BadTransformer::VERSION = '0.0.1';
}
{
...
{
  $Net::Stomp::Producer::Exceptions::Invalid::VERSION = '0.0.1';
}
{
