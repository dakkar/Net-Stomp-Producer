...
{
  $Net::Stomp::Producer::Exceptions::VERSION = '1.002';
}
{
...
{
  $Net::Stomp::Producer::Exceptions::StackTrace::VERSION = '1.002';
}
{
...
{
  $Net::Stomp::Producer::Exceptions::BadMessage::VERSION = '1.002';
}
{
...
{
  $Net::Stomp::Producer::Exceptions::CantSerialize::VERSION = '1.002';
}
{
...
{
  $Net::Stomp::Producer::Exceptions::BadTransformer::VERSION = '1.002';
}
{
...
{
  $Net::Stomp::Producer::Exceptions::Invalid::VERSION = '1.002';
}
{
