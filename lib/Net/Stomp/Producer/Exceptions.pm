...
{
  $Net::Stomp::Producer::Exceptions::VERSION = '2.0';
}
{
...
{
  $Net::Stomp::Producer::Exceptions::StackTrace::VERSION = '2.0';
}
{
...
{
  $Net::Stomp::Producer::Exceptions::BadMessage::VERSION = '2.0';
}
{
...
{
  $Net::Stomp::Producer::Exceptions::CantSerialize::VERSION = '2.0';
}
{
...
{
  $Net::Stomp::Producer::Exceptions::BadTransformer::VERSION = '2.0';
}
{
...
{
  $Net::Stomp::Producer::Exceptions::Invalid::VERSION = '2.0';
}
{
...
{
  $Net::Stomp::Producer::Exceptions::Transactional::VERSION = '2.0';
}
{
